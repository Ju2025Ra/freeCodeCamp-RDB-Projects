...
--
-- Name: elements element_name_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements element_symbol_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT element_symbol_unique UNIQUE (symbol);
